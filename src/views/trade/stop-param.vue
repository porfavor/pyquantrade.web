<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="StopProfitAtrRatio" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.stop_profit_atr_ratio }}</span>
        </template>
      </el-table-column>
      <el-table-column label="StopLossAtrRatio" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.stop_loss_atr_ratio }}</span>
        </template>
      </el-table-column>
      <el-table-column label="StopProfitStep" width="120px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.stop_profit_step }}</span>
        </template>
      </el-table-column>
      <el-table-column label="StopLossStep" width="120px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.stop_loss_step }}</span>
        </template>
      </el-table-column>
      <el-table-column label="StopProfitRetreatRatio" width="180px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.stop_profit_retreat_ratio }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="180px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="StopProfitAtrRatio" prop="stop_profit_atr_ratio">
          <el-input v-model="temp.stop_profit_atr_ratio" />
        </el-form-item>
        <el-form-item label="StopLossAtrRatio" prop="stop_loss_atr_ratio">
          <el-input v-model="temp.stop_loss_atr_ratio" />
        </el-form-item>
        <el-form-item label="StopProfitStep" prop="stop_profit_step">
          <el-input v-model="temp.stop_profit_step" />
        </el-form-item>
        <el-form-item label="StopLossStep" prop="stop_loss_step">
          <el-input v-model="temp.stop_loss_step" />
        </el-form-item>
        <el-form-item label="StopProfitRetreatRatio" prop="stop_profit_retreat_ratio">
          <el-input v-model="temp.stop_profit_retreat_ratio" />
        </el-form-item>
      </el-form>
...
<script>
import { fetchParameter, updateParameter } from '@/api/stop-param'
