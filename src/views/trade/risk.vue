<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="Code" prop="code" align="center" width="120px">
        <template slot-scope="{row}">
          <span>{{ row.code }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Atr" width="100px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.atr }}</span>
        </template>
      </el-table-column>
      <el-table-column label="MktValue" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.mkt_value }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Exposure" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.exposure }}</span>
        </template>
      </el-table-column>
      <el-table-column label="ExpPnl" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.exp_pnl }}</span>
        </template>
      </el-table-column>
    </el-table>
...
//      })
    ...
    getList() {
      ...
      fetchRisk(this.listQuery).then(response => {
